...
export default function SideNavBar() {
    ...
    return (
        <div className={`p-2 items-center flex flex-col w-[80px] space-y-4 shadow-md shadow-teal-600 h-screen sticky top-0 bg-white dark:bg-slate-800 z-20`}>
            <Image src='/logo.png'
            alt='logo'
            width={50}
            height={50}
            ...
            {menu.map((item, index)=>(
                ...
                className="w-10 h-10 hover:text-teal-600
                hover:bg-teal-100
                r-2 cursor-pointer rounded-lg"
                >
